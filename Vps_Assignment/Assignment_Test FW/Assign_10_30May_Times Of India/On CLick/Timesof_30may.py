...
class TimesofIndia(unittest.TestCase):
    ...
    def test_timesofindia(self):
        ...
        pollValueXpath = "//div[@class='_26fds']/descendant::input[@value='Yes']"
        ...
        newsoptionXpath = "//div[@id='homePicGallery']/descendant::a"
        ...
        newschose = driver.find_element_by_xpath("//div[@id='homePicGallery']/descendant::a/span")

        for news in newsoptionXpathElement:
            newschose.click()
